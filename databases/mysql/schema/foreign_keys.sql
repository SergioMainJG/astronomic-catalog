...
ALTER TABLE `Star`
    ADD FOREIGN KEY (`system_id`) REFERENCES `StarSystem` (`id`);


ALTER TABLE `Star`
    ADD FOREIGN KEY (`spectral_type_id`) REFERENCES `StarSpectralType` (`id`);
ALTER TABLE `Star`
    ADD FOREIGN KEY (`constellation_id`) REFERENCES `Constellation` (`id`);
...
ALTER TABLE `Orbit`
    ADD FOREIGN KEY (`celestial_object_id`) REFERENCES `CelestialObject` (`id`) ON DELETE CASCADE;

ALTER TABLE `Orbit`
    ADD FOREIGN KEY (`primary_body_id`) REFERENCES `CelestialObject` (`id`) ON DELETE CASCADE;
